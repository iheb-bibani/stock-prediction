...
def create_train_test_set(df_Stock):
    ...
    selected_features = st.multiselect("", [col for col in df_Stock.columns if col != 'Close_forcast'],default='EMA50')
...
model = st.sidebar.selectbox("Select a Machine Learning/Deep Learning model:", ['Linear Regression','LSTM','Random Forest'])
...
if model == 'Linear Regression':
    ...
    # Inverse transform the predictions to get them back to original scale if scaler is used
